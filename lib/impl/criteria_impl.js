...
/**
 * Add an order to the results to be retrieved.
 * 
 * @param {Criterion} order
 * @returns {CriteriaImpl.prototype}
 */
CriteriaImpl.prototype.addOrder = function(order) {
    if (!order instanceof Order) {
        throw new JCriteriaError('Argument 1 is not an instance of Order');
    }
 ...
 * @returns {CriteriaImpl.prototype}
 */
CriteriaImpl.prototype.setMaxResults = function(maxResults) {
